...
const getCityLabel = (cityKey) => cityKey
    ...
    .replace('Bekes', 'Békés')
    .replace('Oroshaza', 'Orosháza')
    .replace('Szekesfehervar', 'Székesfehérvár')
    .replace('Dunaujvaros', 'Dunaújváros')
    .replace('Gyor', 'Győr')
    .replace('Gyongyos', 'Gyöngyös')
    .replace('Tatabanya', 'Tatabánya')
    .replace('Jaszbereny', 'Jászberény')
    .replace('Komarom', 'Komárom')
    .replace('Esztergom', 'Esztergom')
    .replace('Salgotarjan', 'Salgótarján')
    .replace('Batoryterenye', 'Bátonyterenye')
    .replace('Erd', 'Érd')
    .replace('Budaors', 'Budaörs')
    .replace('Godollo', 'Gödöllő')
    .replace('Vecses', 'Vecsés')
    .replace('Vac', 'Vác')
    .replace('Kaposvar', 'Kaposvár')
    .replace('Siofok', 'Siófok')
    .replace('Nyiregyhaza', 'Nyíregyháza')
    .replace('Kisvarda', 'Kisvárda')
    .replace('Szekszard', 'Szekszárd')
    .replace('Dombovar', 'Dombóvár')
